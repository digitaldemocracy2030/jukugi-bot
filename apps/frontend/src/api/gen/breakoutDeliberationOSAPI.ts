 ...
 */
export type postApiRoomsRoomIdQueueEndSpeakingResponse200 = {
	data: QueueResponse;
	status: 200;
};

export type postApiRoomsRoomIdQueueEndSpeakingResponse401 = {
	data: PostApiRoomsRoomIdQueueEndSpeaking401;
	status: 401;
};

export type postApiRoomsRoomIdQueueEndSpeakingResponse403 = {
	data: PostApiRoomsRoomIdQueueEndSpeaking403;
	status: 403;
};

export type postApiRoomsRoomIdQueueEndSpeakingResponse404 = {
	data: PostApiRoomsRoomIdQueueEndSpeaking404;
	status: 404;
};

export type postApiRoomsRoomIdQueueEndSpeakingResponseSuccess =
	postApiRoomsRoomIdQueueEndSpeakingResponse200 & {
		headers: Headers;
	};
export type postApiRoomsRoomIdQueueEndSpeakingResponseError = (
	| postApiRoomsRoomIdQueueEndSpeakingResponse401
	| postApiRoomsRoomIdQueueEndSpeakingResponse403
	| postApiRoomsRoomIdQueueEndSpeakingResponse404
) & {
	headers: Headers;
};

export type postApiRoomsRoomIdQueueEndSpeakingResponse =
	| postApiRoomsRoomIdQueueEndSpeakingResponseSuccess
	| postApiRoomsRoomIdQueueEndSpeakingResponseError;

export const getPostApiRoomsRoomIdQueueEndSpeakingUrl = (roomId: string) => {
	return `/api/rooms/${roomId}/queue/end-speaking`;
};

export const postApiRoomsRoomIdQueueEndSpeaking = async (
	roomId: string,
	options?: RequestInit,
): Promise<postApiRoomsRoomIdQueueEndSpeakingResponse> => {
	return customFetch<postApiRoomsRoomIdQueueEndSpeakingResponse>(
		getPostApiRoomsRoomIdQueueEndSpeakingUrl(roomId),
		{
			...options,
			method: "POST",
		},
...
export const getPostApiRoomsRoomIdQueueEndSpeakingMutationOptions = <
	TError = ErrorType<
		| PostApiRoomsRoomIdQueueEndSpeaking401
		| PostApiRoomsRoomIdQueueEndSpeaking403
		| PostApiRoomsRoomIdQueueEndSpeaking404
...
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof postApiRoomsRoomIdQueueEndSpeaking>>,
		TError,
		{ roomId: string },
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ["postApiRoomsRoomIdQueueEndSpeaking"];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	> = (props) => {
		...
		return postApiRoomsRoomIdQueueEndSpeaking(roomId, requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type PostApiRoomsRoomIdQueueEndSpeakingMutationResult = NonNullable<
	Awaited<ReturnType<typeof postApiRoomsRoomIdQueueEndSpeaking>>
>;

export type PostApiRoomsRoomIdQueueEndSpeakingMutationError = ErrorType<
	| PostApiRoomsRoomIdQueueEndSpeaking401
	| PostApiRoomsRoomIdQueueEndSpeaking403
	| PostApiRoomsRoomIdQueueEndSpeaking404
>;
 ...
 * @summary End own speaking turn early
 */
export const usePostApiRoomsRoomIdQueueEndSpeaking = <
	TError = ErrorType<
		| PostApiRoomsRoomIdQueueEndSpeaking401
		| PostApiRoomsRoomIdQueueEndSpeaking403
		| PostApiRoomsRoomIdQueueEndSpeaking404
...
>(
	...
	TContext
> => {
	return useMutation(getPostApiRoomsRoomIdQueueEndSpeakingMutationOptions(options), queryClient);
};
